        ...
        return (
            !loading && <View style={{ backgroundColor: this.props.style[0].ViewBackgroundColorPrimary, height: '100%' }}>
                ...
                <View style={{ backgroundColor: this.props.style[0].ViewBackgroundColorPrimary, height: '80%', justifyContent: 'center', alignItems: 'center' }}>
                    <SLIicon name="eye" style={{ fontSize: 70, color: 'white', padding: 20, color: this.props.style[0].ButtonBackgroundColorPrimary }}></SLIicon>
                    ...
                    <InvisibleUITestButton color="transparent" title=" " accessibilityLabel="landingsignup" testID="landingsignup" onPress={() => Actions.signupmain()} style={{ height: 0, width: 0, color:"transparent" }} />
                    <InvisibleUITestButton color="transparent" title=" " accessibilityLabel="landinglogin" testID="landinglogin" onPress={() => Actions.loginmain()} style={{ height: 0, width: 0, color:"transparent" }} />
                </View>
